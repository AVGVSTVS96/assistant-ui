  ...
  parameters={[
    {
      name: "toolName",
      type: "string",
      description: "The name of the tool. This must match the name of the tool defined in the assistant. This corresponds to the `name` property of the tool definition object you create with the `tool()` helper and register using `makeAssistantTool`.",
    },
    {
      name: "render",
      type: "function",
